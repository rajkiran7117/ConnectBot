...
var formatAccountPrivate = function(privateAccount){
	...
	console.log("destination is: "+JSON.stringify(privateAccount[0].get("personcontact").Destination__r.Name));
	var isVisible = {"name":""+privateAccount[0].get("name"),"fbId":""+privateAccount[0].get("Facebook_PSID__c"),"preferredchannel": ""+privateAccount[0].get("Preferred_Communication_Channel__c"),"Id":""+privateAccount[0].get("Id"),"msg":"success", "visible": privateAccount[0].get("visible_to_other_interns_c__pc"), "destination": ""+privateAccount[0].get("personcontact").Destination__r.Name };
